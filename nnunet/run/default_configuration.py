...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
                              ...
                              base_module='nnunet.training.network_training', sub_training_name=None):
    ...
    if sub_training_name is None:
        output_folder_name = join(network_training_output_dir, network, task, network_trainer + "__" + plans_identifier)
    else:
        output_folder_name = join(network_training_output_dir, sub_training_name, task, network_trainer + "__" + plans_identifier)
    print("###############################################")
